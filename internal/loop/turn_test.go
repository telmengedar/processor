...
func TestTurnRunRecordsTheModelsAnswerAndStopsAtOneCallWhenAnswered(t *testing.T) {
	...
	wantLimits := Limits{CandidateLimit: 20, AssemblyByteBudget: 60_000, SupplementaryByteBudget: 20_000, MaxModelCalls: 6, MaxOutputTokens: 4_096, RelevanceFloor: 0.63, MaxFills: 2, FillSizeFloor: 8_000, MaxFillContentBytes: 100_000, SubstanceRatioThreshold: 0.592}
